...
export function CardTitle({ className, ...props }: HTMLAttributes<HTMLHeadingElement>) {
  return (
    <h3
      className={cn(
        'text-xs font-bold leading-none tracking-tight text-[#101828] dark:text-[#F3F4F6]',
        className,
      )}
      {...props}
    />
...
export function CardDescription({ className, ...props }: HTMLAttributes<HTMLParagraphElement>) {
  return (
    <p className={cn('text-[11px] text-[#475467] dark:text-[#B7C0CC]', className)} {...props} />
  );
}
...
export function CardFooter({ className, ...props }: HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn(
        'flex items-center p-4 pt-0 border-t border-[#D9E1EC]/60 dark:border-[#2A313A]/60 mt-3',
        className,
      )}
      {...props}
    />
