              ...
              <form onSubmit={handleSubmit} className="mt-4 space-y-3">
                <div className="grid grid-cols-2 gap-2.5">
                  <div>
                    <label
                      htmlFor="firstName"
                      className="block text-xs font-semibold text-[#101828] dark:text-[#F3F4F6] mb-1"
                    >
                      First name
                    </label>
                    <Input
                ...
                <div className="rounded-lg border border-[#D9E1EC] dark:border-[#2A313A] bg-[#F6F8FB] dark:bg-[#181D24] p-2.5 text-[10px] space-y-1 text-[#475467] dark:text-[#B7C0CC]">
                  <div className="font-semibold text-[#101828] dark:text-[#F3F4F6]">
                  ...
                  <div className="grid grid-cols-2 gap-x-2 gap-y-0.5">
                    <span
                      className={
                        hasLength
                          ? 'text-[#0E8A73] dark:text-[#2BC7A4] font-semibold'
                    ...
                    <span
                      className={
                        hasSpecial
                          ? 'text-[#0E8A73] dark:text-[#2BC7A4] font-semibold col-span-2'
                          : 'text-[#98A2B3] dark:text-[#858F9D] col-span-2'
                      }
                    >
                      {hasSpecial ? '✓' : '○'} Symbol (!@#$%^&*)
                    </span>
