  ...
  return (
    <main className="relative flex min-h-dvh w-full flex-col justify-between overflow-x-hidden bg-[#F6F8FB] dark:bg-[#0A0D12] text-[#101828] dark:text-[#F3F4F6] select-none transition-colors duration-200">
      ...
      <div
        ...
        aria-hidden="true"
      >
        <div className="absolute -left-24 -top-24 h-96 w-96 rounded-full bg-[radial-gradient(circle_at_center,rgba(53,106,230,0.06)_0%,transparent_70%)] dark:bg-[radial-gradient(circle_at_center,rgba(91,140,255,0.08)_0%,transparent_70%)] blur-2xl sm:h-125 sm:w-125" />
        <div className="absolute right-0 top-1/4 h-96 w-96 rounded-full bg-[radial-gradient(circle_at_center,rgba(24,184,154,0.05)_0%,transparent_70%)] dark:bg-[radial-gradient(circle_at_center,rgba(43,199,164,0.06)_0%,transparent_70%)] blur-3xl sm:h-137.5 sm:w-137.5" />
      </div>
      ...
      >
        ...
        >
          <defs>
            ...
            <linearGradient id="reg-curve-grad" x1="120" y1="750" x2="1480" y2="180" gradientUnits="userSpaceOnUse">
          ...
          <rect width="1600" height="900" fill="url(#reg-grid)" opacity="0.6" />
          <path
            d="M 120 740 C 400 720, 600 580, 850 440 C 1100 300, 1300 200, 1480 180"
            stroke="url(#reg-curve-grad)"
            strokeWidth="2"
            strokeLinecap="round"
          />
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-1 items-center justify-center px-4 py-6 sm:px-8 lg:px-12">
        <div className="grid w-full items-center gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(360px,460px)] lg:gap-14 xl:gap-16">
          ...
          {/* Right Registration Card (Content-Driven Sizing) */}
          <div className="flex w-full justify-center lg:justify-end min-w-0">
            <div className="w-full max-w-[460px] rounded-2xl border border-[#D9E1EC] dark:border-[#2A313A] bg-white dark:bg-[#11151B] p-6 sm:p-8 shadow-sm">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-[#475467] dark:text-[#B7C0CC]">
                  Start tracking household accounts, budgets, and savings goals.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="mt-4 space-y-3">
                <div className="grid grid-cols-2 gap-2.5">
                  <div>
                    <label htmlFor="firstName" className="block text-xs font-semibold text-[#101828] dark:text-[#F3F4F6] mb-1">
                      First name
                    </label>
                    <Input
                      id="firstName"
                  ...
                  <div>
                    <label htmlFor="lastName" className="block text-xs font-semibold text-[#101828] dark:text-[#F3F4F6] mb-1">
                      Last name
                    </label>
                    <Input
                      id="lastName"
                ...
                <div>
                  <label htmlFor="email" className="block text-xs font-semibold text-[#101828] dark:text-[#F3F4F6] mb-1">
                    Email address
                  </label>
                  <Input
                    id="email"
                ...
                <div>
                  <label htmlFor="password" className="block text-xs font-semibold text-[#101828] dark:text-[#F3F4F6] mb-1">
                    Password
                  </label>
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-2.5 top-2 rounded p-0.5 text-[#98A2B3] dark:text-[#858F9D] hover:text-[#101828] dark:hover:text-[#F3F4F6] focus:outline-none transition"
                      tabIndex={-1}
                ...
                <div>
                  <label htmlFor="confirmPassword" className="block text-xs font-semibold text-[#101828] dark:text-[#F3F4F6] mb-1">
                    Confirm password
                  </label>
                  <Input
                    id="confirmPassword"
                ...
                <div className="rounded-lg border border-[#D9E1EC] dark:border-[#2A313A] bg-[#F6F8FB] dark:bg-[#181D24] p-2.5 text-[10px] space-y-1 text-[#475467] dark:text-[#B7C0CC]">
                  <div className="font-semibold text-[#101828] dark:text-[#F3F4F6]">Security Requirements:</div>
                  <div className="grid grid-cols-2 gap-x-2 gap-y-0.5">
                    <span className={hasLength ? 'text-[#0E8A73] dark:text-[#2BC7A4] font-semibold' : 'text-[#98A2B3] dark:text-[#858F9D]'}>
                      {hasLength ? '✓' : '○'} Min 8 chars
                    </span>
                    <span className={hasUpper ? 'text-[#0E8A73] dark:text-[#2BC7A4] font-semibold' : 'text-[#98A2B3] dark:text-[#858F9D]'}>
                      {hasUpper ? '✓' : '○'} Uppercase letter
                    </span>
                    <span className={hasLower ? 'text-[#0E8A73] dark:text-[#2BC7A4] font-semibold' : 'text-[#98A2B3] dark:text-[#858F9D]'}>
                      {hasLower ? '✓' : '○'} Lowercase letter
                    </span>
                    <span className={hasDigit ? 'text-[#0E8A73] dark:text-[#2BC7A4] font-semibold' : 'text-[#98A2B3] dark:text-[#858F9D]'}>
                      {hasDigit ? '✓' : '○'} Number (0-9)
                    </span>
                    <span className={hasSpecial ? 'text-[#0E8A73] dark:text-[#2BC7A4] font-semibold col-span-2' : 'text-[#98A2B3] dark:text-[#858F9D] col-span-2'}>
                      {hasSpecial ? '✓' : '○'} Symbol (!@#$%^&*)
                    </span>
                  </div>
                </div>
                ...
                <Button
                  type="submit"
                  className="w-full mt-1 h-9 font-bold text-xs shadow-xs active:translate-y-px transition"
              ...
              <div className="mt-4 border-t border-[#D9E1EC]/70 dark:border-[#2A313A]/70 pt-3 text-center text-xs text-[#475467] dark:text-[#B7C0CC]">
                Already have an account?{' '}
                <Link to="/login" className="font-semibold text-[#356AE6] dark:text-[#5B8CFF] hover:underline">
                  Sign in
                </Link>
              </div>
